...
interface Props {
  ...
  onMaskSelected?: (imageUrl: string) => void;
}
...
export const GptMessageSelectableImage = ({
  ...
  const onMouseUp = () => {
    ...
    onMaskSelected && onMaskSelected(url);
  ...
  const resetCanvas = () => {
    ...
    onMaskSelected && onMaskSelected(imageUrl);
  };
    ...
    <div className="col-start-1 col-end-9 p-3 rounded-lg">
      <div className="flex flex-row items-start">
        ...
        <div className="relative ml-3 text-md bg-black bg-opacity-25 pt-3 pb-2 px-4 shadow rounded-xl">
          {isEditable ? (
            <>
              <span className="text-md">Editando imagen</span>
              <canvas
                ref={canvasRef}
                width={1024}
                height={1024}
            ...
            <>
              ...
              <img
                src={imageUrl}
                alt={alt}
                className="mt-2 rounded-xl aspect-auto"
